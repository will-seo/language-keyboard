...
const meta: MetaData = {
  title: 'Privacy Policy | Language Keyboard',
  description: 'Read out Privacy Policy.',
  image: '/ogimage.png',
};
...
const AboutPage = (props: PageProps) => {
  ...
  return (
    <Layout globalContext={globalContext} h1={h1} meta={meta}>
      <p>Language Keyboard operates the https://languagekeyboard.net/ website, which provides the SERVICE.</p>

      <p>
        This page is used to inform website visitors regarding our policies with the collection, use, and disclosure of
        Personal Information if anyone decided to use our Service, the Language Keyboard website.
      </p>
      ...
      <p>
        ...
        at https://languagekeyboard.net/, unless otherwise defined in this Privacy Policy.
      </p>
      ...
      <p>
        ...
        <a href="mailto:will@langaugekeyboard.net">contact us</a>.
      </p>
    </Layout>
  );
};
